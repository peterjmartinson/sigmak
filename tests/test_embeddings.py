...
class TestEmbeddingEngine(unittest.TestCase):
    """
    Test suite for the EmbeddingEngine.
    ...
    def test_encode_returns_float32_array(self) -> None:
        """
    ...
    def test_encode_handles_multiple_texts(self) -> None:
        """
    ...
    def test_similarity_financial_vs_unrelated(self) -> None:
        """
        ...
        sim_financial = self.engine.get_similarity(financial_1, financial_2)
        sim_unrelated = self.engine.get_similarity(financial_1, unrelated)
    ...
    def test_similarity_identical_texts(self) -> None:
        ...
        sim = self.engine.get_similarity(text, text)
